...
describe('modelBase', function () {
  ...
  describe('initialize', function () {
    ...
    it('should be separately applyable or used as a bookshelf plugin', function () {
      var Model
      expect(bookshelf.Model.findOne).to.be.undefined()
      bookshelf.plugin(function () {
        Model = require('../lib/index').apply(null, arguments)
        expect(Model).to.be.an('function')
      })
      expect(bookshelf.Model.findOne).to.be.a('function')
      expect(Model.findOne).to.be.equal(bookshelf.Model.findOne)
    })
  })
